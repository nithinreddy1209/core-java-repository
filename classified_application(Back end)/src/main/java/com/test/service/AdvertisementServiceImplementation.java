...
public class AdvertisementServiceImplementation implements AdvertisementService {
	...
	@Override
	public Advertisement addDetails( String title, String text, Date postDateTime, 
			String status,String location, String lastDate, double price, User user, Category category) throws IOException {
		...
		advertisement.setPostDateTime(postDateTime);
		advertisement.setStatus(status);
		advertisement.setLocation(location);
		advertisement.setLastDate(lastDate);
