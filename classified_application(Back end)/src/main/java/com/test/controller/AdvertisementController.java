...
public class AdvertisementController {
	...
	public ResponseEntity<?> addAdvertisementInfo(
			
			@RequestParam("title") String title,
			@RequestParam("text") String text,
			@RequestParam("postdate") Date postDateTime,
			...
			) throws IOException
	{
		...
		try
		{
			Advertisement adv = advertisementService.addDetails( title,text,postDateTime,
					status,location,lastDate,price,user,category);
	...
	public ResponseEntity<?>  getAdvertisement(@PathVariable Long id) throws Exception
	{
		...
		if(advertisement.isPresent())
		{
			...
			return new ResponseEntity<Advertisement>(advertisement.get(),HttpStatus.CREATED);
		}
		else
		{
			response.put("status", "failed");
	...
	public  ResponseEntity<?>  getAdvertisementByUSer(@PathVariable Long id) throws Exception
	{
		...
		else
		{
			...
			return new ResponseEntity<List>(advertisement,HttpStatus.CREATED);
		}
